...
**Authoring skills for this profile** — see `references/skill-authoring.md` for the full in-repo and user-local SKILL.md authoring workflow, including frontmatter required fields, size limits, writing-quality principles, and the peer-matched structure guide.
...
hermes pets                 Browse/install/select animated mascots (see `references/petdex-mascots.md`)
