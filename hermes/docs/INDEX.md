...
| 文档 | 内容 | 何时看 |
|---|---|---|
| `design/design-decisions.md` | **8 个核心设计决策**（ADR 六段式：背景/方案对比/为什么/代价/教训）| 想理解系统"为什么这么设计" |
| `../README.md` | 项目全景 + 架构 + 验证入口 | 刚接触项目 |
| `../tools/README.md` | 40+ 工具的操作索引（按"想做什么"查）| 做任何操作前 |
...
| `target-winrate-design-20260814.md` | 目标胜率设计（L1-50 教学段 / 151-200 统一目标）|
| `target-winrate-period-tiering-20260814.md` | 目标胜率分段定档 |
| `experience-curve-period-layering-20260814.md` | 体验曲线分层（感知对数尺度）|
| `experience-scale-review-20260814.md` | 体验尺度评审 |
